                    ...
                    <div class="dropdown navbar-nav ms-auto mb-2 mb-lg-0">
                        <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="user-menu d-flex">
                                ...
                                <div
                                    class="user-img d-flex align-items-center nav-link active dropdown-toggle text-gray-600">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            ...
                            {{-- <li><a class="dropdown-item" href="#"><i class="icon-mid bi bi-person me-2"></i> My
                                    Profile</a></li> --}}
                            <li><a class="dropdown-item" href="#"><i class="icon-mid bi bi-bell me-2"></i>
                                    Notification</a></li>
                            <li class="d-flex justify-content-between"><label class="dropdown-item"><i class="icon-mid bi bi-palette me-2"></i>
                                    Tema
                            </label>
