                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a href="/kepala/data" class="dropdown-item">Terdapat pengajuan surat penindakan
                                            dari Charlie</a></li>
                                    <li><a href="/kepala/data" class="dropdown-item">Terdapat pengajuan surat penindakan
                                            dari Bravo</a></li>
                                    <li><a href="/kepala/data" class="dropdown-item">Terdapat pengajuan surat penindakan
                        ...
                        <div class="dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="user-menu d-flex">
                                    <div class="user-name text-end me-3">
                                        ...
                                        <p class="mb-0 text-sm text-gray-600">Kepala Kantor</p>
                                    </div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                ...
                                <li class="d-flex justify-content-between"><label class="dropdown-item"><i
                                            class="icon-mid bi bi-palette me-2"></i>
                                        Tema
                                    </label>
